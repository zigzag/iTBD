...
CREATE TABLE "timelogs" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "start_at" datetime, "end_at" datetime, "date" date, "task_id" integer, "created_at" datetime, "updated_at" datetime, "task_name" varchar(255));
